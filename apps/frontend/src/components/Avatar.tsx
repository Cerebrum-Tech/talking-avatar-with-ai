...
interface CustomGLTF extends GLTF {
  nodes: {
    ...
    Wolf3D_Outfit_Bottom_1: THREE.SkinnedMesh;
    Wolf3D_Outfit_Bottom_2: THREE.SkinnedMesh;
    Wolf3D_Outfit_Bottom001_1: THREE.SkinnedMesh;
    Wolf3D_Outfit_Bottom001_2: THREE.SkinnedMesh;
  };
  materials: {
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
        ...
        <skinnedMesh
          geometry={nodes.Wolf3D_Outfit_Bottom_1.geometry}
          material={materials.Wolf3D_Outfit_Bottom}
          skeleton={nodes.Wolf3D_Outfit_Bottom_1.skeleton}
        />
        <skinnedMesh
          geometry={nodes.Wolf3D_Outfit_Bottom_2.geometry}
          material={materials.KOYU}
          skeleton={nodes.Wolf3D_Outfit_Bottom_2.skeleton}
        />
        <skinnedMesh
          geometry={nodes.Wolf3D_Outfit_Bottom001_1.geometry}
          material={materials['Wolf3D_Outfit_Top.002']}
          skeleton={nodes.Wolf3D_Outfit_Bottom001_1.skeleton}
        />
        <skinnedMesh
          geometry={nodes.Wolf3D_Outfit_Bottom001_2.geometry}
          material={materials.ribbon}
          skeleton={nodes.Wolf3D_Outfit_Bottom001_2.skeleton}
        />
      </group>
    </group>
  );
